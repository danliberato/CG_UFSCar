...
int main( )
{
    ...
    Model ourModel1("res/models/Roads/Roads.obj");
    // Load models
	Model ourModel2( "res/models/nanosuit/nanosuit.obj" );
    // Draw in wireframe
    ...
    while( !glfwWindowShouldClose( window ) )
    {
        ...
        model2 = glm::translate( model2, glm::vec3( -1.5f, 0.0f, 0.0f ) ); // Translate it down a bit so it's at the center of the scene
        model2 = glm::rotate(model2, -5.0f, glm::vec3( 0, 1, 0 ));
        model2 = glm::scale( model2, glm::vec3( 0.15f, 0.15f, 0.15f ) );	// It's a bit too big for our scene, so scale it down
